...
const AGENT_ORDER = [
  ...
  "qa-automation-engineer", "database-architect", "devops-engineer",
  "backend-specialist", "frontend-specialist", "seo-specialist",
  "mobile-developer", "game-developer", "performance-optimizer",
  "product-manager", "product-owner",
  "project-planner", "code-archaeologist", "documentation-writer", "penetration-tester",
];
...
Ao despachar subagentes, prefira os especialistas abaixo.
...
${fixedRulesBlock("Engineering rules", ROOT_FIXED_RULES)}
