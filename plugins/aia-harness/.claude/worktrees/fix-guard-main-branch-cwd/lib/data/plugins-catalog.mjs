...
export const MARKETPLACES = [
  ...
  },
  {
    ...
    description:
      "UI/UX Pro Max — design intelligence skill (styles, palettes, typography) by nextlevelbuilder.",
  },
];
...
export const PLUGIN_SUGGESTIONS = [
  // Language servers (one per detected language).
  {
    ...
    when: (p) => langIn(p, ["TypeScript", "JavaScript"]),
  },
  {
    name: "pyright-lsp",
    marketplace: OFFICIAL,
  ...
  // Always-on core (auto-installed by default).
  {
    ...
    marketplace: OFFICIAL,
    purpose: "development",
    description: "Setup helpers incl. the claude-automation-recommender used by /aia-harness:init.",
  },
  {
    ...
    purpose: "development",
    description:
      "CLAUDE.md audit/improve + revise-claude-md (claude-md-improver, revise-claude-md skills).",
  },
  {
    name: "superpowers",
  ...
  },
  {
    ...
    purpose: "workflow",
    description:
      "UI/UX design intelligence: 67 styles, 96 palettes, 57 font pairings, 25 charts, 13 stack guidelines (nextlevelbuilder).",
  },
  {
    name: "context7",
    marketplace: OFFICIAL,
    purpose: "search",
    description: "Up-to-date library/framework docs (plugin form).",
  },
  {
    name: "github",
    marketplace: OFFICIAL,
    purpose: "workflow",
    description: "GitHub issues / PRs / releases integration.",
    when: (p) => p.vcs.isGit,
  },
  // Quality.
  {
    ...
    marketplace: OFFICIAL,
    purpose: "quality",
    description: "Create hooks from conversation patterns to prevent repeat mistakes.",
  },
  {
    name: "code-review",
    marketplace: OFFICIAL,
    purpose: "quality",
    description: "Structured pull-request / diff review.",
  },
  {
    name: "pr-review-toolkit",
    marketplace: OFFICIAL,
    purpose: "quality",
    description: "Deeper PR review workflow.",
    when: (p) => p.vcs.isGit,
  },
  {
    ...
    marketplace: OFFICIAL,
    purpose: "quality",
    description: "Security best-practice guidance and review.",
  },
  // Workflow.
  {
    ...
    marketplace: OFFICIAL,
    purpose: "workflow",
    description: "Commit / push / open-PR helper commands.",
  },
  {
    name: "feature-dev",
    marketplace: OFFICIAL,
  ...
  },
  {
    ...
    marketplace: OFFICIAL,
    purpose: "workflow",
    description: "Distinctive, production-grade frontend implementation (Anthropic).",
  },
];
