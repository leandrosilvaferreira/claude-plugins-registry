...
export const FRAMEWORKS = [
  ...
  { name: "Laminas", category: "fullstack", ecosystem: "php", depPrefixes: ["laminas/"] },
  {
    ...
    category: "fullstack",
    ecosystem: "php",
    markers: ["wp-config.php", "wp-load.php"],
  },
  { name: "Drupal", category: "fullstack", ecosystem: "php", deps: ["drupal/core"] },
  {
    ...
    category: "fullstack",
    ecosystem: "php",
    deps: ["adianti/framework"],
    markers: ["lib/adianti", "engine.php", "menu.xml"],
  },
  ...
  // ---- JVM ----
  {
    ...
    depPrefixes: ["org.springframework.boot"],
  },
